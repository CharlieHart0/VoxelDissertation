namespace pointcache.Frustum {
    ...
    public class FrustumBaseComponent : MonoBehaviour {
        ...
        public Camera TakeParametersFromCameraInstead; // added this myself because wasnt working as intended
        ...
        protected virtual void Awake() {
            ...
            m_config.VerticalFov = TakeParametersFromCameraInstead.fieldOfView;
            m_config.HorizontalFov = Camera.VerticalToHorizontalFieldOfView(TakeParametersFromCameraInstead.fieldOfView,TakeParametersFromCameraInstead.aspect);
            m_config.NearPlaneDistance = TakeParametersFromCameraInstead.nearClipPlane;
            m_config.FarPlaneDistance = TakeParametersFromCameraInstead.farClipPlane;
